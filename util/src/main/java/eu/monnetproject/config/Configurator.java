...
public class Configurator {
    ...
    private static final Logger log = Logging.getLogger(Configurator.class);
    ...
    public static Properties getConfig(String pid) {
        String sysProp = null;
        final Bundle bundle = OSGiUtil.getFrameWorkBundle();
        if (bundle != null && bundle.getBundleContext() != null) {
            sysProp = bundle.getBundleContext().getProperty(pid);
        } else {
            sysProp = System.getProperty(pid);
        }
        if (sysProp == null) {
